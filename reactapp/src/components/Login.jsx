...
const LoginForm = () => {
  ...
  return (
    <div className="min-vh-100 d-flex align-items-center justify-content-center bg-light">
      <div className="container" style={{ marginLeft: '330px' }}>
        <div className="row shadow-lg rounded-4 overflow-hidden" style={{ maxWidth: '900px' }}>
          {/* Left: Image Column */}
          <div className="col-md-6 d-none d-md-flex p-0">
            <div style={{
              ...
              <img
                src="https://plus.unsplash.com/premium_photo-1685141420004-1b13a03c54ca?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Ymxvb2QlMjBkb25vciUyMGFwcHxlbnwwfHwwfHx8MA%3D%3D"
